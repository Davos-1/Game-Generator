...
Die HTML-Mockups zeigen A4 im Maßstab **2 px = 1 mm** (420 × 594 px = 210 × 297 mm).
...
Seitenaufteilung sind final. Die Schriftgrößen in den Mockups sind maßstäblich
...
4. **Deckblatt trägt eine große Illustration** (85 mm) statt eines 52-mm-Icons,
   plus einen zweifarbigen Doppelrahmen (`accent` außen, `decor` innen).

## Screens / Views

### 1. Deckblatt (`layout/cover.ts`)
- **Purpose**: Titelseite des Hefts, personalisiert mit Name, Anlass, Datum.
- **Layout**: A4 Hochformat, Rand 12 mm. Doppelrahmen: äußerer Rahmen 0.8 mm
...
- **Inhalt, von oben, zentriert**:
  ...
  | Grußzeile | Inter Regular, 12 pt, `ink`, am unteren Rand des Inhaltsbereichs |
...
- **Kinder-Sudoku**: 6 × 6, Gesamtbreite 165 mm, zentriert. Außenrahmen 0.8 pt in
...
- **Labyrinth**: quadratisches Feld 186 × 186 mm, Rahmen 0.7 pt in `ink`.
  ...
  rechts unten, je mit 0.5 pt weißem Rand, damit sie sich von den Wänden lösen.
- **Fußzeile**: links `corner`-Icon 8 × 8 mm bei 50 % Deckkraft plus
...
- **Fußzeile**: `raetselheft.ch`, Inter Regular 8 pt in `muted`, links unten.
...
- Die PNGs haben **weißen bzw. hellen Bildhintergrund, keine Transparenz**. Wo ein
...
- Bei 400 × 400 px und 85 mm Platzierung ergeben sich ~120 dpi. Für den Druck
  ...
  (Zielgröße ≥ 1000 px für 85 mm ≈ 300 dpi). Für Sudoku- und Ecken-Größen ist die
...
3. `cover.ts` auf Doppelrahmen + große Illustration umbauen.
4. Ecken-Deko und Fußzeile in `page.ts` zentral setzen, damit alle Rätselseiten
   sie erben.
